...
public class FileWriterUtil
{
     ...
     */
    public static boolean streamBytes(byte[] bytes, FileOutputStream out)
    {
        try
        {
            out.write(bytes);
     ...
     */
    public static boolean writeString(String text, File destination)
    {
        return doString(text, destination, false);
    }
     ...
     */
    public static boolean appendString(String text, File destination)
    {
        return doString(text, destination, true);
    }
    
    /**
     *
     */
    private static boolean doString(String text, File destination, boolean append)
    {
        try
        {
            FileOutputStream out = new FileOutputStream(destination, append);
